...
class PopulateConfigTest {
    ...
    void buildingCustomPopulateConfig1() {
        PopulateConfig populateConfig = PopulateConfig.builder()
                ...
                .and()
                .reorderStrategies(BUILDER, SETTER)
                .build();
    ...
    @Test
    void canEnableAccessNonPublicConstructorsAndObjectFactory() {
        PopulateConfig config = PopulateConfig.builder()
                .accessNonPublicConstructors(true)
                .objectFactory(true)
                .and()
                .build();
        assertThat(config.isAccessNonPublicConstructors()).isTrue();
    ...
    void implicitStrategyRegistration() {
        ...
        assertThat(populateConfig.getStrategyOrder())
                .containsExactly(BUILDER, SETTER, MUTATOR, STATIC_METHOD, FIELD, CONSTRUCTOR);
    }
