...
public class AllArgsConstructorExtendsAllArgsConstructorAbstract extends AllArgsConstructorAbstract {
    ...
    public AllArgsConstructorExtendsAllArgsConstructorAbstract(
        ...
        super(
                ...
                inet6Address,
                inetSocketAddress,
                mapWithWildcardValue,
                listWithWildcard,
                setWithWildcard,
                mapWithWildcardKeyAndValue,
                queueWithWildcard,
                dequeWithWildcard,
                sortedSetWithWildcard,
                navigableSetWithWildcard,
                sortedMapWithWildcard,
                navigableMapWithWildcard,
                concurrentMapWithWildcard,
                concurrentNavigableMapWithWildcard,
                concurrentSkipListMapWithWildcard,
                copyOnWriteArrayListWithWildcard,
                copyOnWriteArraySetWithWildcard,
                concurrentSkipListSetWithWildcard,
                treeMapWithWildcard,
                treeSetWithWildcard,
                arrayListWithWildcard,
                linkedListWithWildcard,
                hashMapWithWildcard,
                linkedHashMapWithWildcard,
                hashSetWithWildcard,
                linkedHashSetWithWildcard,
