...
@Getter
public class CustomBuilderCustomName {
    ...
    private CustomBuilderCustomName(CustomBuilderBuilder builder) {
    ...
    public static CustomBuilderBuilder newBuilder() {
    ...
    public static class CustomBuilderBuilder {
        ...
        public CustomBuilderCustomName done() {
            return new CustomBuilderCustomName(this);
        }
    }
}
